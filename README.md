...
- Make sure you have the client private key and the server public keys, generated by _setup.sh_ script during validator engine initialization, stored in `./certs` directory.
