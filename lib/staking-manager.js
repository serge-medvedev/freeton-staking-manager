...
class StakingManager {
    ...
    async getLatestStakeAndWeight() {
        ...
        const weights = [calcWeight(curKey), calcWeight(prevKey)];
        ...
        const parseList = list => {
            ...
            const [[/* id */, /* unfreezeAt */, /* stakeHeld */, /* vsetHash */, /* frozenDict */, totalStake, /* bonuses */, /* complaints */], tail] = list;

            return [...parseList(tail), parseInt(totalStake)]; // Yeah, in reverse order.
        }
        const totalStake = _
